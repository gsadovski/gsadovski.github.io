...
The outer horizon, $r_{H}^{+}$, is the actual event horizon of the Kerr black hole. The inner one, $r_{H}^{-}$, is a Cauchy horizon: a boundary beyond which the determinism of Einstein's equations breaks down (see *[How predictive is General Relativity?](/blog/2025/cauchy-problem)*).
