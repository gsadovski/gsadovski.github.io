...
According to Noether's 1st theorem, the BRST symmetry above then implies that the YM dynamics is off-shell constrained by \eqref{eq:noethersidentities}, and that there will be an on-shell conserved Noether current and charge, namely, 
