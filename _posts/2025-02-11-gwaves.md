...
Finally, as $C^{\omega}$ solutions, plane waves are too artificial to exist in nature. They're eternal and have an unrealistic degree of symmetry. On the other hand, every wave --- realistic or not --- can reflect, refract, diffract, *etc*. So, a lot of physics can be derived from plane waves, in despite of them being non-physical.
