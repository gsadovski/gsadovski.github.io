...
$$ h^{(1)} = 2\mathrm{Re} \left( A e^{i k \cdot \mathbb{x}}\right) \;,  $$ 
...
A very important property exclusive of transverse waves is called *polarization* or *polarization modes*.

e discuss it next, These give a very clear description of how real g-waves stretch and squeeze spacetime (and matter) as they pass by.
